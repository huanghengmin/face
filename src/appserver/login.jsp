...
<%@page contentType="text/html;charset=utf-8" import="com.hzih.face.recognition.web.SiteContext" %>
...
<div style="width: 466px; height: 320px; border: 0px solid #000000; margin: 0 auto; margin-top: 120px; background: url(img/login.jpg) no-repeat;">

    <form name="loginForm" action="login.action" method="post" style="margin: 0; padding: 0;border:0;"
          onsubmit="return checkForm();">

        <div style="padding: 100px 0 0 180px">
