Ext.onReady(function() {
    ...
    var record = new Ext.data.Record.create([
        ...
        {name:'compareResult',		mapping:'compareResult'},
        {name:'badFriend',		mapping:'badFriend'},
    ...
    var proxy = new Ext.data.HttpProxy({
        url:"../../FaceCompareResultAction_find.action"
    });
...
//        boxM,
        ...
        {header:"时间",	dataIndex:"logTime",       align:'center',sortable:true,menuDisabled:true},
        ...
        {header:"原始照片",	dataIndex:"imagePath",       align:'center',sortable:true,menuDisabled:true,renderer:show_pic},
        {header:"比中信息",	dataIndex:"compareResult",       align:'center',sortable:true,menuDisabled:true},
        {header:"单人/团体",	dataIndex:"badFriend",       align:'center',sortable:true,menuDisabled:true},
        {header:"相似值",	dataIndex:"score",       align:'center',sortable:true,menuDisabled:true},
        {header:"特征码",	dataIndex:"featureId",       align:'center',sortable:true,menuDisabled:true},
        {header:"任务号",	dataIndex:"taskId",       align:'center',sortable:true,menuDisabled:true},
...
function show_pic(value){
    return "<img src='../../ImageAction_show_photo_small.action?filePath='"+encodeURI(value)+"'&width=50&height=50'/>";
}
