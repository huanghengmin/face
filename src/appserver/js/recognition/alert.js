Ext.onReady(function () {
    ...
    var record = new Ext.data.Record.create([
        ...
        {name: 'personInfo', mapping: 'personInfo'},
        {name: 'ipcFilePath', mapping: 'ipcFilePath'},
        {name: 'personFilePath', mapping: 'personFilePath'},
        {name: 'alertLevel', mapping: 'alertLevel'}
    ]);
    var proxy = new Ext.data.HttpProxy({
        url: "../../AlertAction_find.action"
    });
...
//        boxM,
        rowNumber,
        {header: '终端编号', dataIndex: 'terminalId', align: 'center', sortable: true, menuDisabled: true, width: 50},
        {header: "任务号", dataIndex: "taskId", align: 'center', sortable: true, menuDisabled: true, width: 50},
        {header: "报警时间", dataIndex: "alertTime", align: 'center', sortable: true, menuDisabled: true},
        {header: "场所", dataIndex: "place", align: 'center', sortable: true, menuDisabled: true},
        {header: "经度", dataIndex: "latitude", align: 'center', sortable: true, menuDisabled: true, width: 50},
        {header: "纬度", dataIndex: "longitude", align: 'center', sortable: true, menuDisabled: true, width: 50},
        {header: "报警等级", dataIndex: "alertLevel", align: 'center', sortable: true, menuDisabled: true, width: 50},
        {header: "特征码", dataIndex: "featureId", align: 'center', sortable: true, menuDisabled: true, width: 50},
        {header: "相似值", dataIndex: "score", align: 'center', sortable: true, menuDisabled: true, width: 50},
        {header: "身份信息", dataIndex: "personInfo", align: 'center', sortable: true, menuDisabled: true},
        {
            header: "原始IPC图片",
            dataIndex: "ipcFilePath",
            align: 'center',
            sortable: true,
            menuDisabled: true,
            renderer: show_ipc
...
function show_ipc(value) {
    alert(value);
    var w = 50;
    var h = 50;
    var src = '../../ImageAction_show_photo_small.action?width='+w+'&height='+h+'&filePath='+encodeURIComponent(value);
    return "<img src='"+src+"'/>";
}

function show_file(value) {
    var w = 50;
    var h = 50;
    var src = '../../ImageAction_show_photo_small.action?width='+w+'&height='+h+'&filePath='+encodeURIComponent(value);
    return "<img src='"+src+"'/>";
