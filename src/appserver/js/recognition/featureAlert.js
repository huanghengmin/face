Ext.onReady(function() {
    ...
    var proxy = new Ext.data.HttpProxy({
        url:"../../FeatureAlertAction_find.action"
    });
...
//        boxM,
        ...
        {header:"动作",	dataIndex:"action",       align:'center',sortable:true,menuDisabled:true},
        {header:"报警目标库",	dataIndex:"targetDB",       align:'center',sortable:true,menuDisabled:true},
        {header:"报警级别",	dataIndex:"alertLevel",       align:'center',sortable:true,menuDisabled:true},
