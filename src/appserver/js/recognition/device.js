Ext.onReady(function() {
    ...
    var record = new Ext.data.Record.create([
        ...
        {name:'terminalNetStatus',		mapping:'terminalNetStatus'},
        {name:'terminalCpuUse',		mapping:'terminalCpuUse'},
        {name:'terminalCpuTemperature',		mapping:'terminalCpuTemperature'},
        {name:'terminalMem',		mapping:'terminalMem'},
        {name:'ipcNetStatus',		mapping:'ipcNetStatus'},
        {name:'ipcComparisonStatus',		mapping:'ipcComparisonStatus'},
        {name:'ipcPictureStatus',		mapping:'ipcPictureStatus'},
        {name:'lastTime',		mapping:'lastTime'}
    ]);
    var proxy = new Ext.data.HttpProxy({
        url:"../../DeviceAction_find.action"
    });
...
//        boxM,
        rowNumber,
        {header:'终端编号',		dataIndex:'terminalId',		   align:'center',sortable:true,menuDisabled:true},
        {header:"组织/机构",	dataIndex:"organization",       align:'center',sortable:true,menuDisabled:true},
        {header:"部门/科室",	dataIndex:"institution",       align:'center',sortable:true,menuDisabled:true},
        {header:"场所",	dataIndex:"place",       align:'center',sortable:true,menuDisabled:true},
        {header:"地址",	dataIndex:"address",       align:'center',sortable:true,menuDisabled:true},
        {header:"经度",	dataIndex:"latitude",       align:'center',sortable:true,menuDisabled:true},
        {header:"纬度",	dataIndex:"longitude",       align:'center',sortable:true,menuDisabled:true},
...
function show_flag(value, p, r) {
    return String.format(
        ...
        '<a id="capture.info" href="javascript:void(0);" onclick="capture();return false;"style="color: green;">抓图</a>&nbsp;&nbsp;&nbsp;' +
        '<a id="config.info" href="javascript:void(0);" onclick="config();return false;"style="color: green;">配置</a>&nbsp;&nbsp;&nbsp;' +
        '<a id="reboot.info" href="javascript:void(0);" onclick="reboot();return false;"style="color: green;">重启</a>&nbsp;&nbsp;&nbsp;' +
        '<a id="upgrade.info" href="javascript:void(0);" onclick="upgrade();return false;"style="color: green;">升级</a>&nbsp;&nbsp;&nbsp;'
...
function listen() {
    Ext.MessageBox.alert("开启监控","开启监控");
}

function capture() {
    Ext.MessageBox.alert("抓图","抓图");
}

function config() {
    Ext.MessageBox.alert("配置","配置");
}

function reboot() {
    Ext.MessageBox.alert("重启","重启");
}

function upgrade() {
    Ext.MessageBox.alert("升级","升级");
}
