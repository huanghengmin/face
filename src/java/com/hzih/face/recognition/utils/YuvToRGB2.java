...
//                RGB tmp = yuvTorgb(src[Y], src[U], src[V]);
    ...
    private static RGB ycbcr2rgb(int Y,int Cb,int Cr){
...
//   int MyB = (int)(Y + 1.772 * (Cb -128));
        ...
        int MyG = (int)(1.164 * (Y - 16) - 0.813 * (Cb - 128) - 0.392 * (Cr - 128));
        int MyB = (int)(1.164 * (Y - 16) + 2.017 * (Cb -128));
